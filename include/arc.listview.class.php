...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<a class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</a>\r\n";
        }
        $purl = $this->GetCurUrl();
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<a class=\"pageinfo\">共 1 页/".$this->TotalResult." 条记录</a>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<a class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</a>\r\n";
        }
        $maininfo = "<a class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a class=\"p_btn_pre\" href='".$purl."PageNo=$nextpagenum'>下一页</a>\r\n";
